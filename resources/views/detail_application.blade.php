  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form class="row g-3" method="POST">  
        ...
        <div class="col-md-3">
          <img src="{{asset('images')}}/{{$data->image}}" width="80px" height="80px" alt="Image">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id="inputPassword4" disabled value="{{$data->fname}}">
        </div>
        <div class="col-12">
        ...
        <div class="row mt-3 mb-3">
          <label for="inputPassword3" class="col-sm-3">Uploaded File</label>
          <div class="col-sm-9">
            @php 
              $files = $data->file;
              $value = explode(",", $files); 
        ...
        <div class="row mb-3 justify-content-end">
          <div class="col-md-3">
            <input type="submit" formaction="{{route('accept.reject')}}" name="approve" value="Approve" class="btn btn-facebook btn-block">
          </div>
          <div class="col-md-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{route('education.accept')}}" method="POST">
                @csrf
