...
<div class="container-fluid">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-7">
                <form class="user pb-5" method="POST" action="{{route('application.update')}}">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input name="phone" type="text" class="form-control " id="exampleInputEmail"
                                value="{{$data->phone}}" >
                            </div>
                            <div class="col-md-4">
                                <label for="formGroupExampleInput" class="form-label">Aadhaar Number</label>
                                <input name="aadhar" type="text" class="form-control " id="exampleInputEmail"
                                value="{{$data->aadhar}}" >
                            </div>
                            <div class="col-md-4">
                                <label for="formGroupExampleInput" class="form-label">Ration Card Number</label>
                                <input name="ration" type="text" class="form-control " id="exampleInputEmail"
                                value="{{$data->ration}}" >
                            </div>
                        </div>
                    </div>
