    ...
    <div class="card-body">
      <form class="row g-3" method="POST">  
        ...
        <div class="row mb-3 justify-content-end">
          <div class="col-md-3">
            <input type="submit" formaction="{{route('treatment.accept')}}" name="approve" value="Approve" class="btn btn-facebook btn-block">
          </div>
          <div class="col-md-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{route('treatment.accept')}}" method="POST">
                @csrf
