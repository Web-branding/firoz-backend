    ...
    <div class="card-body">
      <form class="row g-3" method="POST">  
        ...
        <div class="mt-3 mb-3">
          ...
          <label for="inputPassword3" class="col-12">Uploaded Documents</label>
          <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
            <thead style="background-color:#f8f9fc">
                <tr>
                  <th>Name</th>
        ...
        <div class="row mb-3 justify-content-end">
          <div class="col-md-3">
            <input type="submit" formaction="{{route('education.accept')}}" name="approve" value="Approve" class="btn btn-facebook btn-block">
          </div>
          <div class="col-md-3">
            <!-- <input type="submit" formaction="{{route('education.accept')}}" name="reject" value="Reject" class="btn btn-facebook btn-block"> -->
