...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Education Application List</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-9">
                    <form action="{{route('education.id')}}" class="form-inline mb-3 mr-auto w-100 navbar-search">
                ...
                <div class="col-md-3">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <form method="post" action="{{route('education.sort')}}">
                                @csrf
                    ...
                    <tbody>
                        @foreach($applications as $app)
                            <tr>
                                ...
                                <td>{{$app->priority}}</td>
                                <td>
                                    <a href="{{route('education.edit',$app->id)}}" class="btn btn-success btn-sm btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fa fa-pencil" aria-hidden="true"></i>
                                        </span>
                                        <span class="text">Edit</span>
                                    </a>
                                    <a href="{{route('education.show',$app->id)}}" class="btn btn-info btn-sm btn-icon-split">
                                        <span class="icon text-white-50">
