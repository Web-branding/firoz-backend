...
Route::get('app-update&{id}', [ApplicationController::class, 'edit'])->name('application.edit');
Route::post('app-update', [ApplicationController::class, 'update'])->name('application.update');
Route::get('app-details&{id}', [ApplicationController::class, 'show'])->name('application.show');
Route::post('app-accept-reject', [ApplicationController::class, 'accept'])->name('application.accept');
Route::delete('app-delete', [ApplicationController::class, 'destroy'])->name('application.destroy');
